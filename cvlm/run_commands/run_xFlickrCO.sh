...
python3 cvlm/run_xFlickrCO_albef.py \
    ...
    --max_seq_length 50  --evaluate_during_training \
    --num_captions_per_img_val 16 --num_images_per_cap_val 16 \
    --output_dir output_xFlickrCO/albef_uni_stage2_xlmr_abl-tlm_init_half/  --save_metric r1  --cuda_devices 5,6,7

# for entangled version
python3 cvlm/ablation/run_xFlickrCO_albef.py \
    --albef_config albef/configs/xFlickrCO/retrieval_base_xFlickrCO_xlm-r_init_freeze_vis.yaml \
    --model_name_or_path pretrain/unified_stage2_xlm-r_all_langs_mono_init_abl-ent_8gpus_half/checkpoint-0112000 \
    --tokenizer_name xlm-roberta-base --image_dir_format local \
    --do_train --do_lower_case --save_steps 4500 \
    --per_gpu_train_batch_size 12 --learning_rate 0.00004 \
    --per_gpu_eval_batch_size 24  --test_lang all \
    --num_train_epochs 10 --weight_decay 0.05 \
    --max_seq_length 50  --evaluate_during_training \
    --num_captions_per_img_val 16 --num_images_per_cap_val 16 \
    --output_dir output_xFlickrCO/albef_uni_stage2_xlmr_abl-ent_init_half/  --save_metric r1  --cuda_devices 0,1,2,3
...
python3 cvlm/run_xFlickrCO_albef.py \
    --albef_config albef/configs/xFlickrCO/retrieval_base_xFlickrCO_xlm-r_init.yaml \
    --eval_model_dir output_xFlickrCO/albef_uni_stage2_xlmr_init/checkpoint-3-7700/ \
    --tokenizer_name xlm-roberta-base  --eval_split translate_test \
    --do_test  --do_eval --do_lower_case --image_dir_format local \
    --per_gpu_eval_batch_size 64  --test_lang all --max_seq_length 50  \
    --num_captions_per_img_val 16 --num_images_per_cap_val 16 \
    --output_dir output_xFlickrCO/evaluation/  --cuda_devices 5,6,7
