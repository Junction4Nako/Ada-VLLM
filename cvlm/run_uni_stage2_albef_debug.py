...
from oscar.parallel_txt_datasets.build import make_mono_txt_loader_ds
...
def main():
    ...
    text_input = tokenizer(test_texts['text'], padding='longest', truncation=True, max_length=64, return_tensors="pt")
    with torch.no_grad():
