...
from .layer import GELU, BertLayer, BertPooler, BertOnlyMLMHead, RobertaLMHead, VisualRobertaLMHead, BertLayerNorm as LayerNorm
...
class VLXLMRTextEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, position_ids=None,token_type_ids=None):
        ...
        # print(words_embeddings.shape, position_embeddings.shape, token_type_embeddings.shape)
