...
def main():
    ...
    if args.txt_txt_mod == 'txt-txt-tlm' or args.txt_txt_mod == 'txt-txt-contras' or args.txt_txt_mod == 'para_txt_full':
    ...
    for step, (batch, batch_extra, batch_txt) in enumerate(zip(train_dataloader, train_dataloader_extra, txt_dataloader), start_iter):
        ...
        if (step + 1) % args.gradient_accumulation_steps == 0:
            ...
            metrics_to_log = {
                ...
                'batch_metrics': {'loss': loss1+loss2+loss_txt, 'mlm_loss':mlm_loss1+mlm_loss2, 'ita_loss':ita_loss1+ita_loss2, 
                        'itm_loss': itm_loss1+itm_loss2, 't2t_loss': loss_t2t, '{}_loss'.format(extra_txt_loss_name): loss_tlm}
            }
