...
from oscar.modeling.modeling_vlbert_pretrain import BiBertImgForPreTrainingMul
...
MODEL_CLASSES = {
    'bert': (BertConfig, BiBertImgForPreTrainingMul, BertTokenizer),
}
...
def main():
    ...
    if args.visual_learning:
        ...
        model_class = BiBertImgForPreTrainingMul
    load_num = 0
    ...
    for step, (batch, batch_extra) in enumerate(zip(train_dataloader, train_dataloader_extra), start_iter):
        ...
        def data_process(mini_batch):
            ...
            phrase_mask_label = mini_batch[13].to(c_device, non_blocking=True)
            ...
            return images, input_ids_a, input_mask_a, segment_ids_a, lm_label_ids_a, input_ids_b, input_mask_b, segment_ids_b, lm_label_ids_b, is_next, is_img_match, phrase_index, image_index, phrase_mask_label

        images1, input_ids_a1, input_mask_a1, segment_ids_a1, lm_label_ids_a1, input_ids_b1, input_mask_b1, segment_ids_b1, lm_label_ids_b1, is_next1, is_img_match, phrase_index, image_index, phrase_mask_label1  = data_process(batch)
