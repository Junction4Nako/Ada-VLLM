...
from blip2.datasets.vl_instruct.build_dataset import make_data_loader_llava
...
def main():
    ...
    model = Blip2Llama(vit_model=config['model']['vit_model'],
                        ...
                        max_output_txt_len=config['model']['max_output_txt_len'],
                        qformer_text_input=config['model']['qformer_text_input'],
                        ada_config=ada_config,
                        ada_tokenizer=tokenizer,
                        llm_model=config['model']['llm'],
                        local_ckpt_cfg=local_ckpt_cfg,
                        forward_mod='instruct_tuning')
    ...
    # image-text pair
    train_dataloaders = make_data_loader_llava(
